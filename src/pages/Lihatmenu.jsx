...
<table class="table p-4 bg-white rounded-lg shadow">
    ...
    <tbody>
        <tr class="text-gray-700">
            ...
            <td class="border p-4 dark:border-dark-5">
               <button className='py-2 px-3 bg-sky-400 hover:bg-sky-600'>Update </button>| <button className='py-2 px-3 bg-red-400 hover:bg-red-600'>Delete</button>
            </td>
        </tr>
